...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_VINE_STALKER,    SK_EVOCATIONS,     -1),
        ...
        // SP_RED_MANDRAKE
    APT(SP_RED_MANDRAKE,    SK_FIGHTING,        -1),
    APT(SP_RED_MANDRAKE,    SK_SHORT_BLADES,     0),
    APT(SP_RED_MANDRAKE,    SK_LONG_BLADES,     -2),
    APT(SP_RED_MANDRAKE,    SK_AXES,            -2),
    APT(SP_RED_MANDRAKE,    SK_MACES_FLAILS,    -1),
    APT(SP_RED_MANDRAKE,    SK_POLEARMS,         0),
    APT(SP_RED_MANDRAKE,    SK_STAVES,           1),
    APT(SP_RED_MANDRAKE,    SK_SLINGS,          -1),
    APT(SP_RED_MANDRAKE,    SK_BOWS,             0),
    APT(SP_RED_MANDRAKE,    SK_CROSSBOWS,       -1),
    APT(SP_RED_MANDRAKE,    SK_THROWING,        -1),
    APT(SP_RED_MANDRAKE,    SK_ARMOUR,          -2),
    APT(SP_RED_MANDRAKE,    SK_DODGING,          1),
    APT(SP_RED_MANDRAKE,    SK_STEALTH,          2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_RED_MANDRAKE,    SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_RED_MANDRAKE,    SK_SHIELDS,        -2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_RED_MANDRAKE,    SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_RED_MANDRAKE,    SK_UNARMED_COMBAT,   1),
    APT(SP_RED_MANDRAKE,    SK_SPELLCASTING,    -1),
    APT(SP_RED_MANDRAKE,    SK_CONJURATIONS,    -2),
    APT(SP_RED_MANDRAKE,    SK_HEXES,            0),
    APT(SP_RED_MANDRAKE,    SK_CHARMS,           0),
    APT(SP_RED_MANDRAKE,    SK_SUMMONINGS,       0),
    APT(SP_RED_MANDRAKE,    SK_NECROMANCY,      -1),
    APT(SP_RED_MANDRAKE,    SK_TRANSLOCATIONS,  -2),
    APT(SP_RED_MANDRAKE,    SK_TRANSMUTATIONS,  -1),
    APT(SP_RED_MANDRAKE,    SK_FIRE_MAGIC,      -4),
    APT(SP_RED_MANDRAKE,    SK_ICE_MAGIC,       -2),
    APT(SP_RED_MANDRAKE,    SK_AIR_MAGIC,       -2),
    APT(SP_RED_MANDRAKE,    SK_EARTH_MAGIC,      2),
    APT(SP_RED_MANDRAKE,    SK_POISON_MAGIC,     3),
    APT(SP_RED_MANDRAKE,    SK_INVOCATIONS,      1),
    APT(SP_RED_MANDRAKE,    SK_EVOCATIONS,       0),
